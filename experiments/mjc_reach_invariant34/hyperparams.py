...
config = {
    ...
    'inner_iterations': 4,
    'to_log': [],
    'robot0_file': BASE_DIR + '/../experiments/mjc_%dlink_reach/data_files/traj_sample_itr_00_rn_00.pkl' % N1_LINKS,
    'robot1_file': BASE_DIR + '/../experiments/mjc_%dlink_reach/data_files/traj_sample_itr_00_rn_00.pkl' % N2_LINKS,
