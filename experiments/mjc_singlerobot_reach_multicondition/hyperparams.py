...
mjc_reach = {
    ...
    'bottom_pos_offsets' : [np.asarray([-0.3, 0.0, 0.9]), np.asarray([0.7, 0., 0.]), np.asarray([0.3, 0.0, 0.5]), np.asarray([-0.5, 0.0, 0.5])],
}
...
agent = [{
    ...
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset': [mjc_reach['top_pos_offsets'][0], mjc_reach['top_pos_offsets'][1], mjc_reach['bottom_pos_offsets'][0], mjc_reach['bottom_pos_offsets'][1],
                        mjc_reach['top_pos_offsets'][2], mjc_reach['bottom_pos_offsets'][2]],
