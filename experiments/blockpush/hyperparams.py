...
from gps.algorithm.policy_opt.tf_model_example_multirobot import example_tf_network_multi, blockpushnet
...
EXP_DIR = BASE_DIR + '/../experiments/blockpush/'
