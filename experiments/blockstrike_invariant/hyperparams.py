...
config = {
    ...
    'robot0_file': BASE_DIR + '/../experiments/blockstrike/data_files/traj_sample_itr_16_rn_00.pkl',
    'robot1_file': BASE_DIR + '/../experiments/blockstrike4/data_files/traj_sample_itr_16_rn_00.pkl',
