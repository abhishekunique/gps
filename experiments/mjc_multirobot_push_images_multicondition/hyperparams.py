...
EXP_DIR = BASE_DIR + '/../experiments/mjc_multirobot_push_images_multicondition/'
...
agent = [{
    ...
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset': [np.array([0, 0.0, 0]), np.array([0, 0., 0.25])],
...
fk_cost_1 = [{
    'type': CostFK,
    'target_end_effector': np.array([0.0, 0.0, 0.0, 0.9, 0.05, 1.45]),
...
{
    'type': CostFK,
    'target_end_effector': np.array([0.0, 0.0, 0.0, 0.9, 0.05, 1.70]),
    'wp': np.array([0, 0, 0, 1, 1, 1]),
    'l1': 0.1,
    'l2': 10.0,
    'alpha': 1e-5,
