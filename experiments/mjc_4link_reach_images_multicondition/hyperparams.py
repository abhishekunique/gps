...
EXP_DIR = BASE_DIR + '/../experiments/mjc_4link_reach_images_multicondition/'
...
agent = [{
    ...
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset':  [mjc_reach['top_pos_offsets'][1],
                         mjc_reach['bottom_pos_offsets'][1],
                         mjc_reach['bottom_pos_offsets'][2]
                     ]+ more_offsets,
    # 'pos_body_offset': more_offsets,
...
final_cost = [{
     ...
     'target_end_effector': fk_cost_1[i]['target_end_effector'],
     'wp': fk_cost_1[i]['wp'],
     'l1': 1.0,
     'l2': 0.0,
     'alpha': 1e-5,
...
algorithm[0]['cost'] = [{
    'type': CostSum,
    'costs': [torque_cost_1[i], fk_cost_1[i]],# final_cost[i]],
    'weights': [1.0, 1.0],
} for i in common['train_conditions']]
