...
SENSOR_DIMS = [{
    JOINT_ANGLES: N1_LINKS,
    JOINT_VELOCITIES: N1_LINKS,
    END_EFFECTOR_POINTS: 6,
    END_EFFECTOR_POINT_VELOCITIES: 6,
    ACTION: N1_LINKS,
},
{
    JOINT_ANGLES: N2_LINKS,
    JOINT_VELOCITIES: N2_LINKS,
    END_EFFECTOR_POINTS: 6,
    END_EFFECTOR_POINT_VELOCITIES: 6,
    ACTION: N2_LINKS,
}]

PR2_GAINS = [np.array([1.0] * N1_LINKS), np.array([1.0] * N2_LINKS)]
BASE_DIR = '/'.join(str.split(gps_filepath, '/')[:-2])
EXP_DIR = BASE_DIR + '/../experiments/mjc_reach_invariant56/'
...
agent = [ {
    'type': AgentMuJoCo,
    'filename': './mjc_models/arm_%dlink_reach.xml' % N1_LINKS,
    'x0': np.zeros(N1_LINKS * 2),
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset': all_offsets,
    'pos_body_idx': np.array([N1_LINKS + 3]),
    ...
    {
    'type': AgentMuJoCo,
    'filename': './mjc_models/arm_%dlink_reach.xml' % N2_LINKS,
    'x0': np.zeros(N2_LINKS * 2),
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset': all_offsets,
    'pos_body_idx': np.array([N2_LINKS + 3]),
    'conditions': common['conditions'],
    'train_conditions': common['train_conditions'],
    'test_conditions': common['test_conditions'],
    'image_width': IMAGE_WIDTH,
...
config = {
    ...
    'inner_iterations': 4,
    'to_log': [],
    'robot0_file': BASE_DIR + '/../experiments/mjc_%dlink_reach/data_files/traj_sample_itr_16_rn_00.pkl' % N1_LINKS,
    'robot1_file': BASE_DIR + '/../experiments/mjc_%dlink_reach/data_files/traj_sample_itr_16_rn_00.pkl' % N2_LINKS,
    'r0_index_list': np.concatenate([np.arange(0,5), np.arange(5,10)]),
    'r1_index_list': np.concatenate([np.arange(0,6), np.arange(6,12)]),
}
