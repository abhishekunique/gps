...
EXP_DIR = BASE_DIR + '/../experiments/mjc_singlerobot_3link_reach_multicondition/'
...
# traj_samples = data_logger.unpickle('~/abhishek_gps/gps/experiements/mjc_singlerobot_3link_reach_multicondition/data_files/traj_sample_3link_itr2')
