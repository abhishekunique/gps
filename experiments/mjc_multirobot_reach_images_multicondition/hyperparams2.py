...
from gps.algorithm.policy_opt.tf_model_pretraining import multi_input_multi_output_images_pretraining
...
common = {
    ...
    'policy_opt': {
        'type': PolicyOptTf,
        'network_model': multi_input_multi_output_images_pretraining,
        'network_params': [{
            'dim_hidden': [10],
            'num_filters': [5, 10],
...
},
{
    ...
    'dt': 0.05,
    'substeps': 5,
    'pos_body_offset':  [np.array([0., 0.0, 0.]), np.array([0., 0., 0.15])],# np.asarray([0.3, 0.0, 0.5]), np.asarray([-0.5, 0.0, 0.5])],
