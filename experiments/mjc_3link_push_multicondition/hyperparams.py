...
EXP_DIR = BASE_DIR + '/../experiments/mjc_3link_push_multicondition/'
...
fk_cost_1 = [{
    'type': CostFK,
    'target_end_effector': np.array([0.8, 0.0, 1.4]),
    'wp': np.array([1, 1, 1]),
    'l1': 0.1,
    'l2': 10.0,
    'alpha': 1e-5,
