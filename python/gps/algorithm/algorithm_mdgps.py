...
class AlgorithmMDGPS(Algorithm):
    ...
    def _update_policy_fit(self, m):
        ...
        pol_mu, pol_sig = self.policy_opt.prob(obs, self.robot_number)[:2]
        ...
        policy_prior.update(samples, self.policy_opt, mode, robot_number=self.robot_number)
