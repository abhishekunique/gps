...
class PolicyOptTf(PolicyOpt):
    ...
    def init_network(self):
        ...
        tf_maps, fc_vars, last_conv_vars, av, ls, indiv_vars, indiv_fc_vars = tf_map_generator(dim_input=self._dO, dim_output=self._dU, batch_size=self.batch_size, 
        ...
        self.indiv_fc_vars = indiv_fc_vars
