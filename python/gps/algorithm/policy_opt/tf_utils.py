...
class TfMap:
    ...
    @classmethod
    def init_from_lists(cls, inputs, outputs, loss, dc_onehots=None):
        ...
        return cls(inputs[0], inputs[1], inputs[2], outputs[0], loss[0], dc_onehots[0])
...
class TfSolver:
    ...
    def __init__(self, loss_scalar, solver_name='adam', base_lr=None, lr_policy=None,
                 momentum=None, weight_decay=None, robot_number=0, fc_vars=None, last_conv_vars=None, dc_vars=None):
