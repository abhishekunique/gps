...
def door_4link(robot_number, num_robots):
    SENSOR_DIMS = {
        JOINT_ANGLES: 6,
        JOINT_VELOCITIES: 6,
    ...
    agent_dict['agent'] = {
        'type': AgentMuJoCo,
        'filename': './mjc_models/4link_door.xml',
        'x0': [np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, 0.4]), np.zeros((6,))]), 
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, -0.4]), np.zeros((6,))]),
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, 0.2]), np.zeros((6,))]), 
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, -0.65]), np.zeros((6,))]),
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, 0.3]), np.zeros((6,))]), 
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0,-0.3]), np.zeros((6,))]),
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, 0.8]), np.zeros((6,))]), 
                np.concatenate([np.array([np.pi/2, 0.0, 0.0, 0.0, 0.0, -0.8]), np.zeros((6,))])],
        'dt': 0.05,
        'substeps': 5,
