...
def push_out_3link_shortjoint(robot_number, num_robots):
    SENSOR_DIMS = {
        JOINT_ANGLES: 5,
        JOINT_VELOCITIES: 5,
    ...
    agent_dict['agent'] = {
        'type': AgentMuJoCo,
        'filename': './mjc_models/new_3link_gripper_push_shortjoint.xml',
        'x0': np.zeros(10),
        'dt': 0.05,
        'substeps': 5,
        # [np.array([1.2, 0.0, 0.4]),np.array([1.2, 0.0, 0.9])]
        'pos_body_offset': [
            [np.array([-0.8, 0.0, 1.1]),np.array([1.0, 0.0, 0.8])],
            [np.array([-0.5, 0.0, -1.1]),np.array([1.2, 0.0, -0.7])],
            [np.array([-0.9, 0.0, 0.7]),np.array([0.5, 0.0, 1.3])],
            [np.array([-0.7, 0.0, -0.6]),np.array([0.8, 0.0, -1.2])],

            [np.array([-0.9, 0.0, 1.]),np.array([0.9, 0.0, 0.7])],
            [np.array([-0.4, 0.0, -1.1]),np.array([1.3, 0.0, -0.7])],
            [np.array([-0.7, 0.0, 0.6]),np.array([0.3, 0.0, 1.2])],
            [np.array([-0.7, 0.0, -0.8]),np.array([0.8, 0.0, -1.3])],
        ],
