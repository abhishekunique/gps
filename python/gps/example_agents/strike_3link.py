...
def strike_3link(robot_number, num_robots):
    SENSOR_DIMS = {
        JOINT_ANGLES: 4,
        JOINT_VELOCITIES: 4,
    ...
    agent_dict['network_params']= {
        ...
        'batch_size': 25,
        'robot_specific_idx': range(3)+range(4,7)+range(8,11)+range(17,20),
        'task_specific_idx': range(3,4)+range(7,8)+range(11,17)+range(20,26),
        'dim_output':3,
