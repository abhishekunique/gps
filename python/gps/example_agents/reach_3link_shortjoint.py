...
def reach_3link_shortjoint(robot_number, num_robots):
    ...
    agent_dict['network_params']= {
        ...
        'task_specific_idx': range(6,9)+range(12,15),#range(9,12)+range(15,18),
    ...
    agent_dict['agent'] = {
        'type': AgentMuJoCo,
        'filename': './mjc_models/arm_3link_reach_shortjoint.xml',
        'x0': np.zeros(6),
        'dt': 0.05,
        'substeps': 5,
