...
#     data_dir = '/home/abhigupta/gps/experiments/mjc_multirobot_reach_images_multicondition_conv2shared/data_files/'
#     onlyfiles = []
#     for itr in range(8):
#         onlyfiles.append('pol_sample_itr_%02d_rn_01.pkl' % itr)
#         targets = all_offsets
#         dists = []
#     print onlyfiles
#     print "------------"
...
#     np.save(data_dir+"mjc_multirobot_reach_conv2shared_r1", cond_dists)

if __name__ == "__main__":
    data_logger = DataLogger()
    data_dir = '/home/abhigupta/gps/experiments/mjc_singlerobot_3link_push/data_files/'
    ...
    for f in onlyfiles:
        ...
        dists.append(dist_list)
    cond_dists = np.asarray(dists)
    np.save(data_dir+"/mjc_singlerobot_3link_push_baseline", cond_dists)
